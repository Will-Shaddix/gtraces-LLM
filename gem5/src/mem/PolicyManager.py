...
class Policy(Enum): vals = ['CascadeLakeNoPartWrs', 'RambusHypo', 'BearWriteOpt', 'FirstTouch']
...
class PolicyManager(AbstractMemory):
    ...
    dram_cache_size = Param.MemorySize('128MiB', "DRAM cache block size in bytes") # size of dram cache
