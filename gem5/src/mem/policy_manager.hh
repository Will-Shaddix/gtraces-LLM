...
class PolicyManager : public AbstractMemory
{
  protected:
    ...
    std::vector<AddrRange> NMT; 
    unsigned NMT_Max_Entries;
    ...
    std::deque <Addr> pktFarMemWriteHybrid; // added for non dram cache
    ...
    // events
    void processLocMemReadEvent(); //changes locMemRead to waitingLocMemReadResp
