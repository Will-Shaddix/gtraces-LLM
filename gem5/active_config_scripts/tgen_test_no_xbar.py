...
system.generators = PyTrafficGen() 
...
system.generators.port = system.scheds[0].cpu_side
...
if options.traffic_mode == 'linear':
    ...
    system.generators.start(createLinearTraffic(generator, options))
elif options.traffic_mode == 'random':
    #system.generator.start(createRandomTraffic(system.generator))
    # for generator in system.generators:
    system.generators.start(createRandomTraffic(generator, options))
else:
